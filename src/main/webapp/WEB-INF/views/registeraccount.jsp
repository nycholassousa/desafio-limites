...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="accountForm" class="form-signin">
        ...
        <spring:bind path="number">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="number" path="number" class="form-control" placeholder="Number"></form:input>
        ...
        <spring:bind path="balance">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="balance" path="balance" class="form-control" placeholder="Balance"></form:input>
